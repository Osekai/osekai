        ...
        <div class="basic-page-content basic-page-inner-content basic-page-inner-content-shown" id="medals__medal-details-content">
            ...
            <div class="medals__medal-beatmap-options">
                ...
                <div class="medals__beatmap-packs-ids">
                    <p>osu!</p>
                    <input type="text" name="" id="medals__beatmap-pack-osu" class="input input-pattern" pattern="[0-9]{0,4}">
                    <p>osu!taiko</p>
                    <input type="text" name="" id="medals__beatmap-pack-taiko" class="input input-pattern" pattern="[0-9]{0,4}">
                    <p>osu!catch</p>
                    <input type="text" name="" id="medals__beatmap-pack-catch" class="input input-pattern" pattern="[0-9]{0,4}">
                    <p>osu!mania</p>
                    <input type="text" name="" id="medals__beatmap-pack-mania" class="input input-pattern" pattern="[0-9]{0,4}">
                </div>
            </div>
        </div>

...
$topdonators = Database::execSimpleSelect("SELECT SUM(DonoAmount) AS TotalDonation, Username, osuId FROM Donations WHERE Checked = 1 GROUP BY Username ORDER BY SUM(DonoAmount) DESC");

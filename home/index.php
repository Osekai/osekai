    ...
    <div class="osekai__panel-container nopadding home__loader-wait" id="home">
        ...
        <div class="home__cover" onload="positionNav();">
            ...
            <div class="home__cover-bottom">
                ...
                <p><?= GetStringRaw("home", "cover.madeFor"); ?></p>
            </div>
        ...
        <div class="home__panel-container">
            ...
            <a class="home__long-panel home__panel-hoverable" style="--paccent: 0, 0, 0; --paccent-bright: 167, 218, 245; background-image: url('img/medalhunters-bg.png');" href="https://discord.gg/8qpNTs6">
                ...
                <div class="home__long-texts">
                    <h1><?= GetStringRaw("home", "discord.title"); ?></h1>
                    <p><?= GetStringRaw("home", "discord.text"); ?></p>
                </div>
            </a>
            <div class="home__panel-row2">
            ...
            <a class="home__long-panel home__panel-hoverable" style="--paccent: 0, 0, 0; --paccent-bright: 237, 132, 213; background-image: url('img/support.png');" href="/donate">
                ...
                <div class="home__long-texts">
                    <h1><?= GetStringRaw("home", "support.title"); ?></h1>
                    <p><?= GetStringRaw("home", "support.text"); ?></p>
                </div>
            </a>
            <div class="home__panel home__faq">
                <div class="home__faq-questions-list">
                    <h1><?= GetStringRaw("home", "faq"); ?></h1>
                    <h3><?= GetStringRaw("home", "faq.title"); ?></h3>
                    <div id="home__faq-list" class="home__faq-questions-list-inner"></div>
                </div>
                <div class="home__faq-answer">
                    <h1 id="home__faq-answer-title" class="home__faq-answer-title"><?= GetStringRaw("home", "faq.welcome"); ?></h1>
                    <div id="home__faq-answer-answer" class="home__faq-answer-answer"><?= GetStringRaw("home", "faq.welcome.intro"); ?></div>
                </div>
            </div>

...
<body>
    ...
    <div class="osekai__panel-container">
        <div class="osekai__3col-panels">
            <div otab-container id="osekai__col1" class="osekai__3col_col1 medals__nomedal">
                <div class="medals__tab-selector">
                    <div otab-button="Medals"></div>
                    <div otab-button="Favourite Medals"></div>
                    <div otab-button="Beatmap Packs"></div>
                </div>
                                ...
                                <div class="osekai__panel-inner">
                                    ...
                                    <div class="osekai__edit__panel">
                                        ...
                                        <p class="osekai__h3">Date</p><input type="date" id="solution__date"
                                            class="osekai__input osekai__100">
                                        <div class="osekai__divider"></div>
                                        <p class="osekai__h3">Date Achieved</p><input type="date" id="solution__dateachieved"
                                            class="osekai__input osekai__100">

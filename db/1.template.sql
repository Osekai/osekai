...
CREATE TABLE `Medals` (
  ...
  `solutionfound` int(1) DEFAULT '0',
  `solutiontrackerenabled` int(1) DEFAULT '1',
  PRIMARY KEY (`medalid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;

INSERT INTO `Medals` (`medalid`, `name`, `link`, `description`, `restriction`, `grouping`, `instructions`, `ordering`, `packid`, `video`, `date`, `firstachieveddate`, `firstachievedby`, `solutionfound`, `solutiontrackerenabled`) VALUES
(1,	'500 Combo',	'https://assets.ppy.sh/medals/web/osu-combo-500.png',	'500 big ones! You\'re moving up in the world!',	'osu',	'Skill & Dedication',	'aiming for a combo of 500 or higher on any beatmap',	0,	NULL,	NULL,	'2008-08-02',	NULL,	NULL,	1,	0),
(3,	'750 Combo',	'https://assets.ppy.sh/medals/web/osu-combo-750.png',	'750 notes back to back? Woah.',	'osu',	'Skill & Dedication',	'aiming for a combo of 750 or higher on any beatmap',	0,	NULL,	NULL,	'2008-08-02',	NULL,	NULL,	1,	0),
(4,	'1,000 Combo',	'https://assets.ppy.sh/medals/web/osu-combo-1000.png',	'A thousand reasons why you rock at this game.',	'osu',	'Skill & Dedication',	'aiming for a combo of at least 1,000 on any beatmap (try a <a href=\'/p/beatmaplist?q=marathon\'>marathon</a>)',	0,	'',	'',	'2008-08-02',	NULL,	NULL,	1,	0),
(5,	'2,000 Combo',	'https://assets.ppy.sh/medals/web/osu-combo-2000.png',	'Nothing can stop you now.',	'osu',	'Skill & Dedication',	'aiming for a combo of at least 2,000 on any beatmap (try a <a href=\'/p/beatmaplist?q=marathon\'>marathon</a>)',	0,	NULL,	NULL,	'2008-08-02',	NULL,	NULL,	1,	0),
(6,	'Don\'t let the bunny distract you!',	'https://assets.ppy.sh/medals/web/all-secret-bunny.png',	'The order was indeed, not a rabbit.',	'osu',	'Hush-Hush',	NULL,	2,	'',	'y9NMDXr1y5I',	'2008-08-11',	NULL,	NULL,	1,	0),
(7,	'Video Game Pack vol.1',	'https://assets.ppy.sh/medals/web/all-packs-gamer-1.png',	'A whole pack of video game goodness, done and dusted. Go you!',	'osu',	'Beatmap Packs',	NULL,	5,	'40',	NULL,	'2008-08-26',	NULL,	NULL,	1,	0),
(8,	'Rhythm Game Pack vol.1',	'https://assets.ppy.sh/medals/web/all-packs-rhythm-1.png',	'Many beats were clicked, but the rhythm isn\'t over yet.',	'osu',	'Beatmap Packs',	NULL,	5,	'41',	NULL,	'2008-08-26',	NULL,	NULL,	1,	0),
(9,	'Internet! Pack vol.1',	'https://assets.ppy.sh/medals/web/all-packs-internet-1.png',	'Did somebody say something about IRC and ICQ?',	'osu',	'Beatmap Packs',	NULL,	5,	'42',	NULL,	'2008-08-26',	NULL,	NULL,	1,	0),
(10,	'Anime Pack vol.1',	'https://assets.ppy.sh/medals/web/all-packs-anime-1.png',	'I-it\'s not like I\'m proud of you or anything..',	'osu',	'Beatmap Packs',	NULL,	5,	'43,0,0,0',	'',	'2008-08-26',	'0000-00-00',	0,	1,	0),
(11,	'Video Game Pack vol.2',	'https://assets.ppy.sh/medals/web/all-packs-gamer-2.png',	'The sequel was no match for your skills, obviously.',	'osu',	'Beatmap Packs',	NULL,	5,	'48',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(12,	'Anime Pack vol.2',	'https://assets.ppy.sh/medals/web/all-packs-anime-2.png',	'Truly dedicated to 2D.',	'osu',	'Beatmap Packs',	NULL,	5,	'49',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(13,	'Catch 20,000 fruits',	'https://assets.ppy.sh/medals/web/fruits-hits-20000.png',	'That is a lot of dietary fiber.',	'fruits',	'Skill & Dedication',	NULL,	3,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(14,	'Video Game Pack vol.3',	'https://assets.ppy.sh/medals/web/all-packs-gamer-3.png',	'True dedication to the gaming art.',	'osu',	'Beatmap Packs',	NULL,	5,	'70',	NULL,	'2009-01-19',	NULL,	NULL,	1,	0),
(15,	'S-Ranker',	'https://assets.ppy.sh/medals/web/all-secret-rank-s.png',	'Accuracy is really underrated.',	'osu',	'Hush-Hush',	NULL,	2,	'',	'5G8xFxHh9OM',	'2009-01-19',	NULL,	NULL,	1,	0),
(16,	'Most Improved',	'https://assets.ppy.sh/medals/web/all-secret-improved.png',	'Now THAT is improvement.',	'osu',	'Hush-Hush',	NULL,	2,	'',	'',	'2009-01-19',	NULL,	NULL,	1,	0),
(17,	'Non-stop Dancer',	'https://assets.ppy.sh/medals/web/all-secret-dancer.png',	'Can you still feel your feet after that?',	'osu',	'Hush-Hush',	NULL,	2,	'',	'',	'2009-01-19',	NULL,	NULL,	1,	0),
(18,	'Internet! Pack vol.2',	'https://assets.ppy.sh/medals/web/all-packs-internet-2.png',	'Straight from an albino black sheep. Wait, what?',	'osu',	'Beatmap Packs',	NULL,	5,	'93',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(19,	'Rhythm Game Pack vol.2',	'https://assets.ppy.sh/medals/web/all-packs-rhythm-2.png',	'You just can\'t stop the beat.',	'osu',	'Beatmap Packs',	NULL,	5,	'94',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(20,	'5,000 Plays',	'https://assets.ppy.sh/medals/web/osu-plays-5000.png',	'There\'s a lot more where that came from.',	'osu',	'Skill & Dedication',	NULL,	1,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(21,	'15,000 Plays',	'https://assets.ppy.sh/medals/web/osu-plays-15000.png',	'Must.. click.. circles..',	'osu',	'Skill & Dedication',	NULL,	1,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(22,	'25,000 Plays',	'https://assets.ppy.sh/medals/web/osu-plays-25000.png',	'There\'s no going back.',	'osu',	'Skill & Dedication',	NULL,	1,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(23,	'Catch 200,000 fruits',	'https://assets.ppy.sh/medals/web/fruits-hits-200000.png',	'So, I heard you like fruit...',	'fruits',	'Skill & Dedication',	NULL,	3,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(24,	'Catch 2,000,000 fruits',	'https://assets.ppy.sh/medals/web/fruits-hits-2000000.png',	'Downright healthy.',	'fruits',	'Skill & Dedication',	NULL,	3,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(25,	'Anime Pack vol.3',	'https://assets.ppy.sh/medals/web/all-packs-anime-3.png',	'You did it for the waifus.',	'osu',	'Beatmap Packs',	NULL,	5,	'207',	NULL,	'2010-03-01',	NULL,	NULL,	1,	0),
(26,	'Rhythm Game Pack vol.3',	'https://assets.ppy.sh/medals/web/all-packs-rhythm-3.png',	'Everyone knows the classics play better on osu! anyway.',	'osu',	'Beatmap Packs',	NULL,	5,	'208',	NULL,	'2010-03-01',	NULL,	NULL,	1,	0),
(27,	'Internet! Pack vol.3',	'https://assets.ppy.sh/medals/web/all-packs-internet-3.png',	'You didn\'t stumble upon this one, I\'m guessing.',	'osu',	'Beatmap Packs',	NULL,	5,	'209',	NULL,	'2010-03-01',	NULL,	NULL,	1,	0),
(28,	'50,000 Plays',	'https://assets.ppy.sh/medals/web/osu-plays-50000.png',	'You\'re here forever.',	'osu',	'Skill & Dedication',	NULL,	1,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(31,	'30,000 Drum Hits',	'https://assets.ppy.sh/medals/web/taiko-hits-30000.png',	'Did that drum have a face?',	'taiko',	'Skill & Dedication',	NULL,	3,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(32,	'300,000 Drum Hits',	'https://assets.ppy.sh/medals/web/taiko-hits-300000.png',	'The rhythm never stops.',	'taiko',	'Skill & Dedication',	NULL,	3,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(33,	'3,000,000 Drum Hits',	'https://assets.ppy.sh/medals/web/taiko-hits-3000000.png',	'Truly, the Don of dons.',	'taiko',	'Skill & Dedication',	NULL,	3,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(34,	'Anime Pack vol.4',	'https://assets.ppy.sh/medals/web/all-packs-anime-4.png',	'Has your ship not sailed?',	'osu',	'Beatmap Packs',	NULL,	5,	'363',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(35,	'Rhythm Game Pack vol.4',	'https://assets.ppy.sh/medals/web/all-packs-rhythm-4.png',	'A click away? More like, right here.',	'osu',	'Beatmap Packs',	NULL,	5,	'365',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(36,	'Internet! Pack vol.4',	'https://assets.ppy.sh/medals/web/all-packs-internet-4.png',	'Must... have... more... memes...',	'osu',	'Beatmap Packs',	NULL,	5,	'366',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(37,	'Video Game Pack vol.4',	'https://assets.ppy.sh/medals/web/all-packs-gamer-4.png',	'You are Player 1.',	'osu',	'Beatmap Packs',	NULL,	5,	'364',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(38,	'Consolation Prize',	'https://assets.ppy.sh/medals/web/all-secret-consolation_prize.png',	'Well, it could be worse.',	'osu',	'Hush-Hush',	NULL,	2,	'',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(39,	'Challenge Accepted',	'https://assets.ppy.sh/medals/web/all-secret-challenge_accepted.png',	'Oh, you\'re ON.',	'osu',	'Hush-Hush',	NULL,	2,	'',	'JKb9aeK-Wv4',	'0000-00-00',	NULL,	NULL,	1,	0),
(40,	'Stumbler',	'https://assets.ppy.sh/medals/web/all-secret-stumbler.png',	'No regrets.',	'osu',	'Hush-Hush',	NULL,	2,	'',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(41,	'Jackpot',	'https://assets.ppy.sh/medals/web/all-secret-jackpot.png',	'Lucky sevens is a mild understatement.',	'NULL',	'Hush-Hush',	NULL,	2,	'',	'',	'2012-08-22',	NULL,	NULL,	1,	0),
(42,	'Quick Draw',	'https://assets.ppy.sh/medals/web/all-secret-quick_draw.png',	'It\'s high noon.',	'NULL',	'Hush-Hush',	NULL,	2,	'',	'',	'2012-08-22',	NULL,	NULL,	1,	0),
(43,	'Obsessed',	'https://assets.ppy.sh/medals/web/all-secret-obsessed.png',	'COMPLETION AT ALL COSTS.',	'NULL',	'Hush-Hush',	NULL,	2,	'',	'',	'2012-08-28',	NULL,	NULL,	1,	0),
(44,	'Nonstop',	'https://assets.ppy.sh/medals/web/all-secret-nonstop.png',	'Breaks? What are those?',	'NULL',	'Hush-Hush',	NULL,	2,	'',	'ZPrltmws1Tw',	'2012-08-28',	NULL,	NULL,	1,	0),
(45,	'Jack of All Trades',	'https://assets.ppy.sh/medals/web/all-secret-jack.png',	'Good at everything.',	'NULL',	'Hush-Hush',	NULL,	2,	'',	'',	'2012-08-28',	NULL,	NULL,	1,	0),
(46,	'40,000 Keys',	'https://assets.ppy.sh/medals/web/mania-hits-40000.png',	'Just the start of the rainbow.',	'mania',	'Skill & Dedication',	NULL,	3,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(47,	'400,000 Keys',	'https://assets.ppy.sh/medals/web/mania-hits-400000.png',	'Four hundred thousand and still not even close.',	'mania',	'Skill & Dedication',	NULL,	3,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(48,	'4,000,000 Keys',	'https://assets.ppy.sh/medals/web/mania-hits-4000000.png',	'Is this the end of the rainbow?',	'mania',	'Skill & Dedication',	NULL,	3,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(50,	'I Can See The Top',	'https://assets.ppy.sh/medals/web/all-skill-highranker-1.png',	'Your dedication has paid off. Welcome to the top 50,000!',	'NULL',	'Skill & Dedication',	NULL,	2,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(51,	'The Gradual Rise',	'https://assets.ppy.sh/medals/web/all-skill-highranker-2.png',	'There\'s no stopping you, is there? Welcome to the top 10,000!',	'NULL',	'Skill & Dedication',	NULL,	2,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(52,	'Scaling Up',	'https://assets.ppy.sh/medals/web/all-skill-highranker-3.png',	'Welcome to the top 5,000. Never give up!',	'NULL',	'Skill & Dedication',	NULL,	2,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(53,	'Approaching The Summit',	'https://assets.ppy.sh/medals/web/all-skill-highranker-4.png',	'Pro tier. Welcome to the top 1,000!',	'NULL',	'Skill & Dedication',	NULL,	2,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(54,	'Twin Perspectives',	'https://assets.ppy.sh/medals/web/mania-secret-meganekko.png',	'You met Mani and Mari, our twin osu!mania mascots.',	'mania',	'Hush-Hush',	NULL,	2,	'0',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(55,	'Rising Star',	'https://assets.ppy.sh/medals/web/osu-skill-pass-1.png',	'Can\'t go forward without the first steps.',	'osu',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(56,	'Constellation Prize',	'https://assets.ppy.sh/medals/web/osu-skill-pass-2.png',	'Definitely not a consolation prize. Now things start getting hard!',	'osu',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(57,	'Building Confidence',	'https://assets.ppy.sh/medals/web/osu-skill-pass-3.png',	'Oh, you\'ve SO got this.',	'osu',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(58,	'Insanity Approaches',	'https://assets.ppy.sh/medals/web/osu-skill-pass-4.png',	'You\'re not twitching, you\'re just ready.',	'osu',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(59,	'These Clarion Skies',	'https://assets.ppy.sh/medals/web/osu-skill-pass-5.png',	'Everything seems so clear now.',	'osu',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(60,	'Above and Beyond',	'https://assets.ppy.sh/medals/web/osu-skill-pass-6.png',	'A cut above the rest.',	'osu',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(61,	'Supremacy',	'https://assets.ppy.sh/medals/web/osu-skill-pass-7.png',	'All marvel before your prowess.',	'osu',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(62,	'Absolution',	'https://assets.ppy.sh/medals/web/osu-skill-pass-8.png',	'My god, you\'re full of stars!',	'osu',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(63,	'Totality',	'https://assets.ppy.sh/medals/web/osu-skill-fc-1.png',	'All the notes. Every single one.',	'osu',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(64,	'Business As Usual',	'https://assets.ppy.sh/medals/web/osu-skill-fc-2.png',	'Two to go, please.',	'osu',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(65,	'Building Steam',	'https://assets.ppy.sh/medals/web/osu-skill-fc-3.png',	'Hey, this isn\'t so bad.',	'osu',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(66,	'Moving Forward',	'https://assets.ppy.sh/medals/web/osu-skill-fc-4.png',	'Bet you feel good about that.',	'osu',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(67,	'Paradigm Shift',	'https://assets.ppy.sh/medals/web/osu-skill-fc-5.png',	'Surprisingly difficult.',	'osu',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(68,	'Anguish Quelled',	'https://assets.ppy.sh/medals/web/osu-skill-fc-6.png',	'Don\'t choke.',	'osu',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(69,	'Never Give Up',	'https://assets.ppy.sh/medals/web/osu-skill-fc-7.png',	'Excellence is its own reward.',	'osu',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(70,	'Aberration',	'https://assets.ppy.sh/medals/web/osu-skill-fc-8.png',	'They said it couldn\'t be done. They were wrong.',	'osu',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(71,	'My First Don',	'https://assets.ppy.sh/medals/web/taiko-skill-pass-1.png',	'Marching to the beat of your own drum. Literally.',	'taiko',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(72,	'Katsu Katsu Katsu',	'https://assets.ppy.sh/medals/web/taiko-skill-pass-2.png',	'Hora! Ikuzo!',	'taiko',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(73,	'Not Even Trying',	'https://assets.ppy.sh/medals/web/taiko-skill-pass-3.png',	'Muzukashii? Not even.',	'taiko',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(74,	'Face Your Demons',	'https://assets.ppy.sh/medals/web/taiko-skill-pass-4.png',	'The first trials are now behind you, but are you a match for the Oni?',	'taiko',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(75,	'The Demon Within',	'https://assets.ppy.sh/medals/web/taiko-skill-pass-5.png',	'No rest for the wicked.',	'taiko',	'Skill & Dedication',	NULL,	4,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(76,	'Drumbreaker',	'https://assets.ppy.sh/medals/web/taiko-skill-pass-6.png',	'Too strong.',	'taiko',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(77,	'The Godfather',	'https://assets.ppy.sh/medals/web/taiko-skill-pass-7.png',	'You are the Don of Dons.',	'taiko',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(78,	'Rhythm Incarnate',	'https://assets.ppy.sh/medals/web/taiko-skill-pass-8.png',	'Feel the beat. Become the beat.',	'taiko',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(79,	'A Slice Of Life',	'https://assets.ppy.sh/medals/web/fruits-skill-pass-1.png',	'Hey, this fruit catching business isn\'t bad.',	'fruits',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(80,	'Dashing Ever Forward',	'https://assets.ppy.sh/medals/web/fruits-skill-pass-2.png',	'Fast is how you do it.',	'fruits',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(81,	'Zesty Disposition',	'https://assets.ppy.sh/medals/web/fruits-skill-pass-3.png',	'No scurvy for you, not with that much fruit.',	'fruits',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(82,	'Hyperdash ON!',	'https://assets.ppy.sh/medals/web/fruits-skill-pass-4.png',	'Time and distance is no obstacle to you.',	'fruits',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(83,	'It\'s Raining Fruit',	'https://assets.ppy.sh/medals/web/fruits-skill-pass-5.png',	'And you can catch them all.',	'fruits',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(84,	'Fruit Ninja',	'https://assets.ppy.sh/medals/web/fruits-skill-pass-6.png',	'Legendary techniques.',	'fruits',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(85,	'Dreamcatcher',	'https://assets.ppy.sh/medals/web/fruits-skill-pass-7.png',	'No fruit, only dreams now.',	'fruits',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(86,	'Lord of the Catch',	'https://assets.ppy.sh/medals/web/fruits-skill-pass-8.png',	'Your kingdom kneels before you.',	'fruits',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(87,	'First Steps',	'https://assets.ppy.sh/medals/web/mania-skill-pass-1.png',	'It isn\'t 9-to-5, but 1-to-9. Keys, that is.',	'mania',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(88,	'No Normal Player',	'https://assets.ppy.sh/medals/web/mania-skill-pass-2.png',	'Not anymore, at least.',	'mania',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(89,	'Impulse Drive',	'https://assets.ppy.sh/medals/web/mania-skill-pass-3.png',	'Not quite hyperspeed, but getting close.',	'mania',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(90,	'Hyperspeed',	'https://assets.ppy.sh/medals/web/mania-skill-pass-4.png',	'Woah.',	'mania',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(91,	'Ever Onwards',	'https://assets.ppy.sh/medals/web/mania-skill-pass-5.png',	'Another challenge is just around the corner.',	'mania',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(92,	'Another Surpassed',	'https://assets.ppy.sh/medals/web/mania-skill-pass-6.png',	'Is there no limit to your skills?',	'mania',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(93,	'Extra Credit',	'https://assets.ppy.sh/medals/web/mania-skill-pass-7.png',	'See me after class.',	'mania',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(94,	'Maniac',	'https://assets.ppy.sh/medals/web/mania-skill-pass-8.png',	'There\'s just no stopping you.',	'mania',	'Skill & Dedication',	NULL,	4,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(95,	'Keeping Time',	'https://assets.ppy.sh/medals/web/taiko-skill-fc-1.png',	'Don, then katsu. Don, then katsu..',	'taiko',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(96,	'To Your Own Beat',	'https://assets.ppy.sh/medals/web/taiko-skill-fc-2.png',	'Straight and steady.',	'taiko',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(97,	'Big Drums',	'https://assets.ppy.sh/medals/web/taiko-skill-fc-3.png',	'Bigger scores to match.',	'taiko',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(98,	'Adversity Overcome',	'https://assets.ppy.sh/medals/web/taiko-skill-fc-4.png',	'Difficult? Not for you.',	'taiko',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(99,	'Demonslayer',	'https://assets.ppy.sh/medals/web/taiko-skill-fc-5.png',	'An Oni felled forevermore.',	'taiko',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(100,	'Rhythm\'s Call',	'https://assets.ppy.sh/medals/web/taiko-skill-fc-6.png',	'Heralding true skill.',	'taiko',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(101,	'Time Everlasting',	'https://assets.ppy.sh/medals/web/taiko-skill-fc-7.png',	'Not a single beat escapes you.',	'taiko',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(102,	'The Drummer\'s Throne',	'https://assets.ppy.sh/medals/web/taiko-skill-fc-8.png',	'Percussive brilliance befitting royalty alone.',	'taiko',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(103,	'Sweet And Sour',	'https://assets.ppy.sh/medals/web/fruits-skill-fc-1.png',	'Apples and oranges, literally.',	'fruits',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(104,	'Reaching The Core',	'https://assets.ppy.sh/medals/web/fruits-skill-fc-2.png',	'The seeds of future success.',	'fruits',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(105,	'Clean Platter',	'https://assets.ppy.sh/medals/web/fruits-skill-fc-3.png',	'Clean only of failure. It is completely full, otherwise.',	'fruits',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(106,	'Between The Rain',	'https://assets.ppy.sh/medals/web/fruits-skill-fc-4.png',	'No umbrella needed.',	'fruits',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(107,	'Addicted',	'https://assets.ppy.sh/medals/web/fruits-skill-fc-5.png',	'That was an overdose?',	'fruits',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(108,	'Quickening',	'https://assets.ppy.sh/medals/web/fruits-skill-fc-6.png',	'A dash above normal limits.',	'fruits',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(109,	'Supersonic',	'https://assets.ppy.sh/medals/web/fruits-skill-fc-7.png',	'Faster than is reasonably necessary.',	'fruits',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(110,	'Dashing Scarlet',	'https://assets.ppy.sh/medals/web/fruits-skill-fc-8.png',	'Speed beyond mortal reckoning.',	'fruits',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(111,	'Keystruck',	'https://assets.ppy.sh/medals/web/mania-skill-fc-1.png',	'The beginning of a new story.',	'mania',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(112,	'Keying In',	'https://assets.ppy.sh/medals/web/mania-skill-fc-2.png',	'Finding your groove.',	'mania',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(113,	'Hyperflow',	'https://assets.ppy.sh/medals/web/mania-skill-fc-3.png',	'You can *feel* the rhythm.',	'mania',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(114,	'Breakthrough',	'https://assets.ppy.sh/medals/web/mania-skill-fc-4.png',	'Many skills mastered, rolled into one.',	'mania',	'Skill & Dedication',	NULL,	5,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(115,	'Everything Extra',	'https://assets.ppy.sh/medals/web/mania-skill-fc-5.png',	'Giving your all is giving everything you have.',	'mania',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(116,	'Level Breaker',	'https://assets.ppy.sh/medals/web/mania-skill-fc-6.png',	'Finesse beyond reason.',	'mania',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(117,	'Step Up',	'https://assets.ppy.sh/medals/web/mania-skill-fc-7.png',	'A precipice rarely seen.',	'mania',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(118,	'Behind The Veil',	'https://assets.ppy.sh/medals/web/mania-skill-fc-8.png',	'Supernatural!',	'mania',	'Skill & Dedication',	NULL,	5,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(119,	'Finality',	'https://assets.ppy.sh/medals/web/all-intro-suddendeath.png',	'High stakes, no regrets.',	'NULL',	'Mod Introduction',	'completing a map with the <b>Sudden Death</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(120,	'Perfectionist',	'https://assets.ppy.sh/medals/web/all-intro-perfect.png',	'Accept nothing but the best.',	'NULL',	'Mod Introduction',	'completing a map with the <b>Perfect</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(121,	'Rock Around The Clock',	'https://assets.ppy.sh/medals/web/all-intro-hardrock.png',	'You can\'t stop the rock.',	'NULL',	'Mod Introduction',	'completing a map with the <b>Hard Rock</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(122,	'Time And A Half',	'https://assets.ppy.sh/medals/web/all-intro-doubletime.png',	'Having a right ol\' time. One and a half of them, almost.',	'NULL',	'Mod Introduction',	'completing a map with the <b>DoubleTime</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(123,	'Sweet Rave Party',	'https://assets.ppy.sh/medals/web/all-intro-nightcore.png',	'Founded in the fine tradition of changing things that were just fine as they were.',	'NULL',	'Mod Introduction',	'completing a map with the <b>Nightcore</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(124,	'Blindsight',	'https://assets.ppy.sh/medals/web/all-intro-hidden.png',	'I can see just perfectly.',	'NULL',	'Mod Introduction',	'completing a map with the <b>Hidden</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(125,	'Are You Afraid Of The Dark?',	'https://assets.ppy.sh/medals/web/all-intro-flashlight.png',	'Harder than it looks, probably because it\'s hard to look.',	'NULL',	'Mod Introduction',	'completing a map with the <b>Flashlight</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(126,	'Dial It Right Back',	'https://assets.ppy.sh/medals/web/all-intro-easy.png',	'Sometimes you just want to take it easy.',	'NULL',	'Mod Introduction',	'completing a map with the <b>Easy</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(127,	'Risk Averse',	'https://assets.ppy.sh/medals/web/all-intro-nofail.png',	'Safety nets are fun!',	'NULL',	'Mod Introduction',	'completing a map with the <b>No Fail</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(128,	'Slowboat',	'https://assets.ppy.sh/medals/web/all-intro-halftime.png',	'You got there. Eventually.',	'NULL',	'Mod Introduction',	'completing a map with the <b>HalfTime</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(131,	'Burned Out',	'https://assets.ppy.sh/medals/web/all-intro-spunout.png',	'One cannot always spin to win.',	'NULL',	'Mod Introduction',	'completing a map with the <b>Spun Out</b> mod enabled!',	0,	NULL,	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(132,	'Perseverance',	'https://assets.ppy.sh/medals/web/all-secret-perseverance.png',	'Endure.',	'NULL',	'Hush-Hush (Expert)',	'<i>Endurance is the key.</i>',	3,	'',	'ZPrltmws1Tw',	'2016-08-17',	NULL,	NULL,	1,	0),
(133,	'Feel The Burn',	'https://assets.ppy.sh/medals/web/all-secret-ftb.png',	'It isn\'t all about how fast you manage.',	'NULL',	'Hush-Hush (Expert)',	'<i>Endurance <strong>and</strong> precision is essential.</i>',	3,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(134,	'Time Dilation',	'https://assets.ppy.sh/medals/web/all-secret-tidi.png',	'Longer is shorter when all is said and done.',	'NULL',	'Hush-Hush',	'<i>Time often flies when one is having fun, though rarely does it last forever.</i>',	2,	'',	'ZPrltmws1Tw',	NULL,	'0000-00-00',	0,	1,	0),
(135,	'Just One Second',	'https://assets.ppy.sh/medals/web/all-secret-onesecond.png',	'And suddenly.. gone.',	'NULL',	'Hush-Hush (Expert)',	'<i>Blink and you\'ll miss it.</i>',	3,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(136,	'Afterimage',	'https://assets.ppy.sh/medals/web/osu-secret-afterimage.png',	'But a glimpse of its true self.',	'osu',	'Hush-Hush',	'<i>Always coming behind the original image.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(137,	'To The Core',	'https://assets.ppy.sh/medals/web/all-secret-tothecore.png',	'In for a penny, in for a pound. Pounding bass, that is.',	'NULL',	'Hush-Hush',	'<i>Double negatives sometimes <strong>do</strong> make a positive.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(138,	'Prepared',	'https://assets.ppy.sh/medals/web/all-secret-prepared.png',	'Do it for real next time.',	'NULL',	'Hush-Hush',	'<i>Preparation is key for all successful endeavours.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(139,	'Eclipse',	'https://assets.ppy.sh/medals/web/osu-secret-eclipse.png',	'Something new born from absence.',	'osu',	'Hush-Hush',	'<i>Do it just because you can, even if the stakes are high.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(140,	'Reckless Abandon',	'https://assets.ppy.sh/medals/web/all-secret-reckless.png',	'Throw it all to the wind.',	'NULL',	'Hush-Hush',	'<i>Do it just because you can, even if the stakes are high.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(141,	'Tunnel Vision',	'https://assets.ppy.sh/medals/web/osu-secret-tunnelvision.png',	'But it was right there..',	'osu',	'Hush-Hush',	'<i>Afraid of the dark?</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(142,	'Behold No Deception',	'https://assets.ppy.sh/medals/web/osu-secret-deception.png',	'That wasn\'t easy at all!',	'osu',	'Hush-Hush',	'<i>Sometimes the hard way is in fact, easier.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(143,	'Up For The Challenge',	'https://assets.ppy.sh/medals/web/all-secret-challenge.png',	'Turn it up to eleven.',	'NULL',	'Hush-Hush (Expert)',	'<i>Everything\'s better at eleven.</i>',	3,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(144,	'Lights Out',	'https://assets.ppy.sh/medals/web/all-secret-lightsout.png',	'The party\'s just getting started.',	'NULL',	'Hush-Hush',	'<i>Set the mood.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(145,	'Unstoppable',	'https://assets.ppy.sh/medals/web/osu-secret-superhardhddt.png',	'Holy shit.',	'osu',	'Hush-Hush (Expert)',	'<i>Reaching the limits of mortal skill.</i>',	3,	'',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(146,	'Is This Real Life?',	'https://assets.ppy.sh/medals/web/osu-secret-supersuperhardhddt.png',	'You did NOT just pull that off.',	'osu',	'Hush-Hush (Expert)',	'<i>The absolute height of perfection.</i>',	3,	'',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(147,	'Camera Shy',	'https://assets.ppy.sh/medals/web/all-secret-uguushy.png',	'Stop being cute.',	'NULL',	'Hush-Hush',	'<i>Uguu.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(148,	'The Sum Of All Fears',	'https://assets.ppy.sh/medals/web/all-secret-nuked.png',	'Unfortunate.',	'NULL',	'Hush-Hush',	'<i>The end comes when you least expect it.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(149,	'Dekasight',	'https://assets.ppy.sh/medals/web/osu-secret-deka.png',	'So big, yet so hard to see.',	'osu',	'Hush-Hush',	'<i>Size isn\'t everything.</i>',	2,	'',	'',	'2016-08-17',	NULL,	NULL,	1,	0),
(150,	'Hour Before The Dawn',	'https://assets.ppy.sh/medals/web/all-secret-hourbeforethedawn.png',	'Eleven skies of everlasting sunrise.',	'NULL',	'Hush-Hush',	'<i>The night where we belong.</i>',	2,	'',	'LLFs8AnU77k',	'0000-00-00',	NULL,	NULL,	1,	0),
(151,	'Slow And Steady',	'https://assets.ppy.sh/medals/web/all-secret-slowandsteady.png',	'Win the race, or start again.',	'NULL',	'Hush-Hush',	'<i>Take your time.</i>',	2,	'',	'',	'2016-10-29',	NULL,	NULL,	1,	0),
(152,	'No Time To Spare',	'https://assets.ppy.sh/medals/web/all-secret-ntts.png',	'Places to be, things to do.',	'NULL',	'Hush-Hush',	'<i>Think fast, click fast, be fast.</i>',	2,	'',	'',	'2016-10-29',	NULL,	NULL,	1,	0),
(153,	'Sognare',	'https://assets.ppy.sh/medals/web/all-secret-sognare.png',	'A dream in stop-motion, soon forever gone.',	'NULL',	'Hush-Hush',	'<i>\"I saw three spires all around, and a world in halted time..\"</i>',	2,	'',	'',	'2016-10-29',	NULL,	NULL,	1,	0),
(154,	'Realtor Extraordinaire',	'https://assets.ppy.sh/medals/web/all-secret-realtor.png',	'An acre-wide stride.',	'NULL',	'Hush-Hush',	'<i>The wrong kind of house.</i>',	2,	'0',	'',	'2016-10-29',	NULL,	NULL,	1,	0),
(155,	'Realität',	'https://assets.ppy.sh/medals/web/all-secret-realitat.png',	'A moonlight butterfly, and beacons of three.',	'NULL',	'Hush-Hush (Expert)',	'<i>Dream of greater heights.</i>',	3,	'0',	'',	'2016-10-29',	NULL,	NULL,	1,	0),
(156,	'Our Mechanical Benefactors',	'https://assets.ppy.sh/medals/web/all-secret-ourbenefactors.png',	'Human, please explain directive \"GREED\".',	'NULL',	'Hush-Hush (Expert)',	'<i>Close, yet so far.</i>',	3,	'0',	'6PgaKfiqVX4',	'2016-10-29',	NULL,	NULL,	1,	0),
(157,	'Meticulous',	'https://assets.ppy.sh/medals/web/osu-secret-meticulous.png',	'The circle goes here, and then here, and then here..',	'osu',	'Hush-Hush',	'<i>This is the way it\'s SUPPOSED to be.</i>',	2,	'',	'',	'2016-10-29',	NULL,	NULL,	1,	0),
(158,	'Infinitesimal',	'https://assets.ppy.sh/medals/web/osu-secret-infinitesimal.png',	'Big word for something so very, very small.',	'osu',	'Hush-Hush',	'<i>Tiny in scope, big in meaning.</i>',	2,	'',	'',	'2016-10-29',	NULL,	NULL,	1,	0),
(159,	'Equilibrium',	'https://assets.ppy.sh/medals/web/osu-secret-equilibrium.png',	'Balance in all things.',	'osu',	'Hush-Hush',	'<i>Seek the middle ground.</i>',	2,	'',	'tSdp2Fp73nc',	'2016-10-29',	NULL,	NULL,	1,	0),
(160,	'Impeccable',	'https://assets.ppy.sh/medals/web/all-secret-impeccable.png',	'Speed matters not to the exemplary.',	'NULL',	'Hush-Hush',	'<i>Simply superb.</i>',	2,	'',	'',	'2016-10-29',	NULL,	NULL,	1,	0),
(161,	'Elite',	'https://assets.ppy.sh/medals/web/all-secret-elite.png',	'Dangerous beat agents.',	'NULL',	'Hush-Hush (Expert)',	'<i>A challenge for status, prestige and fame is not always the smartest thing to do in the middle of something.</i>',	3,	'',	'cilGGKZl7_g',	'0000-00-00',	NULL,	NULL,	1,	0),
(162,	'January/February 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-01.png',	'Two for the price of one.',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the January/Feburary Spotlights for 2017.</i>',	7,	'1186,1187,1188,1189',	'',	'2017-09-22',	'0000-00-00',	0,	1,	0),
(163,	'March 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-03.png',	'March ever onwards.',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the March Spotlights for 2017.</i>',	7,	'1201,1202,1203,1204',	'',	'2017-09-22',	'0000-00-00',	0,	1,	0),
(164,	'April 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-04.png',	'Pitch.. WHAT?',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the April Spotlights for 2017.</i>',	7,	'1219,1220,1221,1222',	'',	'2017-09-22',	'0000-00-00',	0,	1,	0),
(165,	'May 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-05.png',	'May your accuracy forever be swift and true.',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the May Spotlights for 2017.</i>',	7,	'1228,1229,1230,1232',	'',	'2017-09-22',	'0000-00-00',	0,	1,	0),
(166,	'June 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-06.png',	'Innocence destroyed.',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the June Spotlights for 2017.</i>',	7,	'1244,1245,1246,1247',	'',	'2017-09-22',	'0000-00-00',	0,	1,	0),
(167,	'July 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-07.png',	'Where it all begins.',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the July Spotlights for 2017.</i>',	7,	'1253,1254,1255,1256',	'',	'2017-09-22',	'0000-00-00',	0,	1,	0),
(168,	'50/50',	'https://assets.ppy.sh/medals/web/all-secret-5050.png',	'Half full or half empty, that\'s a whole lot of fifty.',	'NULL',	'Hush-Hush (Expert)',	'<i>Strong opinions about this, one way or another.</i>',	3,	'',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(169,	'August 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-08.png',	'Ah, yes. Something just like this.',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the August Spotlights for 2017.</i>',	7,	'1264,1265,1267,1268',	'',	'2017-09-22',	'0000-00-00',	0,	1,	0),
(170,	'Thrill of the Chase',	'https://assets.ppy.sh/medals/web/all-secret-thrillofthechase.png',	'My heart\'s beating, my hands are shaking, and I\'m STILL clicking.',	'osu',	'Hush-Hush (Expert)',	'<i>Is there anything better than the hunt? Such a classic pursuit.</i>',	3,	'0',	'',	'2017-10-31',	NULL,	NULL,	1,	0),
(171,	'The Girl in the Forest',	'https://assets.ppy.sh/medals/web/all-secret-girlintheforest.png',	'Not even the Elite Four could stop you now.',	'NULL',	'Hush-Hush (Expert)',	'<i>Think back to where it all began, in shades of red and blue..</i>',	3,	'0',	'MOeg0gFgY7E',	'2017-10-31',	'0000-00-00',	587737,	1,	0),
(172,	'You Can\'t Hide',	'https://assets.ppy.sh/medals/web/all-secret-youcanthide.png',	'I will find you, and I will click you. All of you.',	'NULL',	'Hush-Hush (Expert)',	'<i>Don\'t even try to hide.</i>',	3,	'',	'',	'2017-10-31',	NULL,	NULL,	1,	0),
(173,	'True Torment',	'https://assets.ppy.sh/medals/web/osu-secret-truetorment.png',	'It lasts forever.',	'osu',	'Hush-Hush (Expert)',	'<i>Note the ghosts.</i>',	3,	'',	'uFMJUTjBWwY',	'2017-10-31',	NULL,	NULL,	1,	0),
(174,	'The Firmament Moves',	'https://assets.ppy.sh/medals/web/all-secret-celestialmovement.png',	'Number fourteen? More like number one.',	'NULL',	'Hush-Hush (Expert)',	'<i>Three times does it move, but most only know one. What you seek is something different yet again, warped three times over.</i>',	3,	'',	'',	'2017-10-31',	NULL,	NULL,	1,	0),
(175,	'Too Fast, Too Furious',	'https://assets.ppy.sh/medals/web/all-secret-toofasttoofurious.png',	'A march if you have eight feet, maybe!',	'NULL',	'Hush-Hush (Expert)',	'<i>Something you don\'t do when you\'re afraid.</i>',	3,	'',	'',	'2017-10-31',	NULL,	NULL,	1,	0),
(176,	'Feelin\' It',	'https://assets.ppy.sh/medals/web/all-secret-feelinit.png',	'Got with the times.',	'NULL',	'Hush-Hush (Expert)',	'<i>Beats multiplied. A lot of them.</i>',	3,	'',	'',	'2017-10-31',	NULL,	NULL,	1,	0),
(177,	'Overconfident',	'https://assets.ppy.sh/medals/web/osu-secret-overconfident.png',	'Try again later, maybe?',	'NULL',	'Hush-Hush (Expert)',	'<i>The \'s\' in progress stands for hubris.</i>',	3,	'',	'',	'2017-10-31',	NULL,	NULL,	1,	0),
(178,	'Spooked',	'https://assets.ppy.sh/medals/web/osu-secret-spooked.png',	'Something moved. It wasn\'t your cursor!',	'NULL',	'Hush-Hush (Expert)',	'<i>Don\'t look behind you.</i>',	3,	'',	'',	'2017-10-31',	NULL,	NULL,	1,	0),
(179,	'MOtOLOiD',	'https://assets.ppy.sh/medals/web/all-packs-motoloid.png',	'Legends made manifest, by the mappers of the Guild.',	'NULL',	'Beatmap Packs',	'<i>Play all of the MOtOLOiD Mapper\'s Guild pack.</i>',	5,	'1284',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(180,	'September 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-09.png',	'New beginnings, time travelers, and airborne robots. Oh my!',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the September Spotlights for 2017.</i>',	7,	'1280,1281,1282,1283',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(181,	'October 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-10.png',	'First, one must distract a punk rock girl. Then, they must put on the radio.',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the October Spotlights for 2017.</i>',	7,	'1292,1293,1294,1295',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(182,	'November 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-11.png',	'The end of an era, and the start of something new!',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the November Spotlights for 2017.</i>',	7,	'1302,1303,1304,1305',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(183,	'December 2017 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2017-12.png',	'Impulse to end the year!',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the December Spotlights for 2017.</i>',	7,	'1331,1332,1333,1334',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(184,	'January 2018 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2018-01.png',	'Reality distorts.',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the January Spotlights for 2018.</i>',	7,	'1354,1355,1356,1357',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(185,	'Mappers\' Guild Pack I',	'https://assets.ppy.sh/medals/web/all-packs-mappersguild-01.png',	'The first among many to come.',	'NULL',	'Beatmap Packs',	'<i>Complete all of the beatmaps in the Mappers\' Guild I pack..</i>',	5,	'1365',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(186,	'February 2018 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2018-02.png',	'Let\'s jump for dreams of future candy!',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the February Spotlights for 2018.</i>',	7,	'1379,1380,1381,1382',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(187,	'March 2018 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2018-03.png',	'Transport me to Nirvana on the backs of angels!',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the March Spotlights for 2018.</i>',	7,	'1405,1407,1408,0',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(188,	'April 2018 Spotlight',	'https://assets.ppy.sh/medals/web/spotlight-2018-04.png',	'A lesson from a DJ: drop kick captivatingly.',	'NULL',	'Beatmap Spotlights',	'<i>Complete any gamemode version of the April Spotlights for 2018.</i>',	7,	'1430,1431,1432,1433',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(189,	'Cranky',	'https://assets.ppy.sh/medals/web/all-packs-cranky.png',	'The grandfather of rhythm gaming music, brought to life by the mappers of the Guild and guests alike.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Cranky pack.</i>',	5,	'1437',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(190,	'Mappers\' Guild Pack II',	'https://assets.ppy.sh/medals/web/all-packs-mappersguild-02.png',	'A variable dream of the future.',	'NULL',	'Beatmap Packs',	'<i>Complete all of the beatmaps in the Mappers\' Guild II pack..</i>',	5,	'1450',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(191,	'High Tea Music',	'https://assets.ppy.sh/medals/web/all-packs-highteamusic.png',	'Silently journeying to invade the skies.',	'NULL',	'Beatmap Packs',	'<i>Complete all of the beatmaps in the Mappers\' Guild III/High Tea Music pack..</i>',	5,	'1480',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(192,	'Skylord',	'https://assets.ppy.sh/medals/web/osu-secret-skylord.png',	'Never miss a wingbeat.',	'osu',	'Hush-Hush (Expert)',	'<i>Flight among the sky requires nothing but perfection.</i>',	3,	'',	'',	'2018-10-23',	'2018-10-23',	2757689,	1,	0),
(193,	'B-Rave',	'https://assets.ppy.sh/medals/web/all-secret-brave.png',	'It takes courage to stand before the master.',	'NULL',	'Hush-Hush (Expert)',	'<i>Ill-tempered bosses make for excellent final battles.</i>',	3,	'',	'',	'2018-10-23',	NULL,	NULL,	1,	0),
(194,	'Any%',	'https://assets.ppy.sh/medals/web/all-secret-anypercent.png',	'A speedrunner\'s best friend.',	'NULL',	'Hush-Hush (Expert)',	'<i>Sometimes you have to break the rules to work with speed.</i>',	3,	'',	'',	'2018-10-23',	NULL,	NULL,	1,	0),
(195,	'Mirage',	'https://assets.ppy.sh/medals/web/all-secret-mirage.png',	'The horizon goes on forever, and ever, and ever...',	'NULL',	'Hush-Hush (Expert)',	'<i>The light is far harder than it seems.</i>',	3,	'',	'',	'2018-10-23',	NULL,	NULL,	1,	0),
(196,	'Under The Stars',	'https://assets.ppy.sh/medals/web/all-secret-underthestars.png',	'Onwards, to where the darkness can never stop us.',	'NULL',	'Hush-Hush (Expert)',	'<i>Walk beneath the stars on a journey to elsewhere.</i>',	3,	'',	'',	'2018-10-23',	NULL,	NULL,	1,	0),
(197,	'Senseless',	'https://assets.ppy.sh/medals/web/all-secret-senseless.png',	'I hear nothing. I see nothing.',	'NULL',	'Hush-Hush (Expert)',	'<i>A song that is, and something that is not.</i>',	3,	'',	'',	'2018-10-23',	NULL,	NULL,	1,	0),
(199,	'Aeon',	'https://assets.ppy.sh/medals/web/all-secret-aeon.png',	'In the mire of thawing time, memory shall be your guide.',	'NULL',	'Hush-Hush',	'<i>When time runs slow and sight fails you, how will you succeed?</i>',	2,	'',	'',	'2018-10-23',	'0000-00-00',	0,	1,	0),
(200,	'Upon The Wind',	'https://assets.ppy.sh/medals/web/all-secret-uponthewind.png',	'And in that gale, no eye could hope to follow.',	'NULL',	'Hush-Hush (Expert)',	'<i>In the heart of a storm of flowers, a world unseen.</i>',	3,	'',	'',	'2018-10-23',	NULL,	NULL,	1,	0),
(201,	'Vantage',	'https://assets.ppy.sh/medals/web/osu-secret-vantage.png',	'There we stood, where the spires pierced the sky, and dreamed of the future to come.',	'osu',	'Hush-Hush (Expert)',	'<i>Where ground was broken to critical acclaim.</i>',	3,	'',	'RQPBfA8WIjw',	'2018-10-23',	NULL,	NULL,	1,	0),
(202,	'Quick Maths',	'https://assets.ppy.sh/medals/web/all-secret-quickmaffs.png',	'Beats per minute over... this isn\'t quick at all!',	'NULL',	'Hush-Hush',	'<i>Where x equals beats per minute, and a variable unknown...</i>',	2,	'',	'',	'2018-10-23',	NULL,	NULL,	1,	0),
(204,	'Efflorescence',	'https://assets.ppy.sh/medals/web/all-secret-efflorescence.png',	'A lament for the past, and a glimpse into tomorrow.',	'NULL',	'Hush-Hush (Expert)',	'<i>The horizon thunders with a portentous bloom.</i>',	3,	'',	'',	'2018-10-23',	NULL,	NULL,	1,	0),
(205,	'Summer 2018 Beatmap Spotlights',	'https://assets.ppy.sh/medals/web/spotlight-2018-summer.png',	'The hottest beatmaps from Summer 2018!',	'NULL',	'Beatmap Spotlights',	'<i>Play all of the maps from one mode of the Summer 2018 Beatmap Spotlights.</i>',	8,	'1508,1509,1510,1511',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(206,	'Culprate',	'https://assets.ppy.sh/medals/web/all-packs-culprate.png',	'A dream of whispers, light, and things to come.',	'NULL',	'Beatmap Packs',	'<i>Complete all of the beatmaps in the Mappers\' Guild IV/Culprate pack.</i>',	5,	'1535',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(207,	'Fall 2018 Beatmap Spotlights',	'https://assets.ppy.sh/medals/web/spotlight-2018-autumn.png',	'The most fabulous beatmaps from Fall 2018!',	'NULL',	'Beatmap Spotlights',	'<i>Play all of the maps from one mode of the Fall 2018 Beatmap Spotlights.</i>',	8,	'1548,1549,1550,1551',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(208,	'HyuN',	'https://assets.ppy.sh/medals/web/all-packs-hyun.png',	'Digital punk goes into overdrive!',	'NULL',	'Beatmap Packs',	'<i>Play all of the HyuN pack.</i>',	5,	'1581',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(209,	'Winter 2019 Beatmap Spotlights',	'https://assets.ppy.sh/medals/web/spotlight-2019-winter.png',	'The chillest beatmaps from Winter 2019!',	'NULL',	'Beatmap Spotlights',	'<i>Play all of the maps from one mode of the Winter 2019 Beatmap Spotlights.</i>',	8,	'1623,1624,1625,1626',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(210,	'Spring 2019 Beatmap Spotlights',	'https://assets.ppy.sh/medals/web/spotlight-2019-spring.png',	'A bloomin\' good time from Spring 2019!',	'NULL',	'Beatmap Spotlights',	'<i>Play all of the maps from one mode of the Spring 2019 Beatmap Spotlights.</i>',	8,	'1670,1671,1672,1673',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(213,	'Imperial Circus Dead Decadence',	'https://assets.ppy.sh/medals/web/all-packs-icdd.png',	'A little kite once sang me a song...',	'NULL',	'Beatmap Packs',	'<i>Play all of the Imperial Circus Dead Decadence pack.</i>',	5,	'1688',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(214,	'tieff',	'https://assets.ppy.sh/medals/web/all-packs-tieff.png',	'Flow.',	'NULL',	'Beatmap Packs',	'<i>Play all of the tieff pack.</i>',	5,	'1649',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(215,	'Summer 2019 Beatmap Spotlights',	'https://assets.ppy.sh/medals/web/spotlight-2019-summer.png',	'Blaze a trail through the best of Summer 2019!',	'NULL',	'Beatmap Spotlights',	'<i>Play all of the maps from one mode of the Summer 2019 Beatmap Spotlights.</i>',	8,	'1722,1723,1724,1725',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(216,	'Inundate',	'https://assets.ppy.sh/medals/web/all-secret-inundate.png',	'Swept away.',	'NULL',	'Hush-Hush (Expert)',	'<i>Across and beyond the tides.</i>',	3,	'',	'',	'2019-10-30',	NULL,	NULL,	1,	0),
(217,	'Not Bluffing',	'https://assets.ppy.sh/medals/web/osu-secret-bluffing.png',	'Did that with my eyes closed.',	'osu',	'Hush-Hush (Expert)',	'<i>It\'s not arrogance if you can live up to it.</i>',	3,	'',	'LQOSNo_ZquY',	'2019-10-30',	'2020-04-23',	6192650,	1,	0),
(218,	'Eureka!',	'https://assets.ppy.sh/medals/web/all-secret-eureka.png',	'By Jove, you\'ve got it!',	'NULL',	'Hush-Hush (Expert)',	'<i>When inspiration strikes...</i>',	3,	'',	'',	'2019-10-30',	NULL,	NULL,	1,	0),
(219,	'Regicide',	'https://assets.ppy.sh/medals/web/all-secret-regicide.png',	'A king no more.',	'NULL',	'Hush-Hush (Expert)',	'<i>No throne lasts forever.</i>',	3,	'',	'',	'2019-10-30',	NULL,	NULL,	1,	0),
(220,	'Permadeath',	'https://assets.ppy.sh/medals/web/all-secret-permadeath.png',	'One life, one shot.',	'NULL',	'Hush-Hush (Expert)',	'<i>Better make it count! Ware well the example of the white cat.</i>',	3,	'',	'',	'2019-10-30',	NULL,	NULL,	1,	0),
(221,	'The Future Is Now',	'https://assets.ppy.sh/medals/web/all-secret-futureisnow.png',	'The stars showed you all that was to come.',	'NULL',	'Hush-Hush (Expert)',	'<i>Withstand the primordial.</i>',	3,	'0',	'',	'2019-10-30',	NULL,	NULL,	1,	0),
(222,	'Natural 20',	'https://assets.ppy.sh/medals/web/all-secret-nat20.png',	'Rolled it.',	'NULL',	'Hush-Hush (Expert)',	'<i>Not just a chance of the dice, this one is all skill.</i>',	3,	'0',	'',	'2019-10-30',	NULL,	NULL,	1,	0),
(223,	'Kaleidoscope',	'https://assets.ppy.sh/medals/web/all-secret-kaleidoscope.png',	'So many pretty colours. Most of them red.',	'NULL',	'Hush-Hush',	'<i>See the tiny colours up through the tube up close and personal, and slow right down.</i>',	2,	'',	'',	'2019-10-30',	NULL,	NULL,	1,	0),
(224,	'AHAHAHAHA',	'https://assets.ppy.sh/medals/web/all-secret-yandere.png',	'TOGETHER FOREVER.',	'NULL',	'Hush-Hush (Expert)',	'<i>Who am I? Where am I? What the hell IS this place?</i>',	3,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(225,	'Valediction',	'https://assets.ppy.sh/medals/web/all-secret-valediction.png',	'One last time.',	'NULL',	'Hush-Hush',	'<i>Time stood still as we waved farewell.</i>',	2,	NULL,	NULL,	'2019-10-30',	NULL,	NULL,	1,	0),
(226,	'Mappers\' Guild Pack III',	'https://assets.ppy.sh/medals/web/all-packs-mappersguild-03.png',	'Sunrise was the end of a very magical night for one very special girl.',	'NULL',	'Beatmap Packs',	'<i>Complete all maps in the Mappers\' Guild Pack III.</i>',	5,	'1689',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(227,	'Mappers\' Guild Pack IV',	'https://assets.ppy.sh/medals/web/all-packs-mappersguild-04.png',	'This freeway is a sensation and boy, does it love you!',	'NULL',	'Beatmap Packs',	'<i>Complete all maps in the Mappers\' Guild Pack IV.</i>',	5,	'1757',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(228,	'Autumn 2019 Beatmap Spotlights',	'https://assets.ppy.sh/medals/web/spotlight-2019-autumn.png',	'Fall straight into the best maps of Autumn 2019!',	'NULL',	'Beatmap Spotlights',	'<i>Play all of the maps from one mode of the Autumn 2019 Beatmap Spotlights.</i>',	8,	'1798,1799,1800,1801',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(229,	'Afterparty',	'https://assets.ppy.sh/medals/web/all-packs-afterparty.png',	'Encore to the core.',	'NULL',	'Beatmap Packs',	'<i>Complete the Afterparty beatmap pack.</i>',	5,	'1542',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(230,	'Ben Briggs',	'https://assets.ppy.sh/medals/web/all-packs-benbriggs.png',	'Chiptunes, Pokemon, oh my!',	'NULL',	'Beatmap Packs',	'<i>Play all of the Ben Briggs pack.</i>',	5,	'1687',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(231,	'Carpool Tunnel',	'https://assets.ppy.sh/medals/web/all-packs-carpooltunnel.png',	'Not to be confused with an injury common to top-end players and people who watch anime.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Carpool Tunnel pack.</i>',	5,	'1805',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(232,	'Creo',	'https://assets.ppy.sh/medals/web/all-packs-creo.png',	'Dashing geometrically to a beatmap near you.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Creo pack.</i>',	5,	'1807',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(233,	'cYsmix',	'https://assets.ppy.sh/medals/web/all-packs-cysmix.png',	'Dead funky. For real.',	'NULL',	'Beatmap Packs',	'<i>Play all of the cYsmix pack.</i>',	5,	'1808',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(234,	'Fractal Dreamers',	'https://assets.ppy.sh/medals/web/all-packs-fractaldreamers.png',	'Shattered dreams and muted skies never sounded so good.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Fractal Dreamers pack.</i>',	5,	'1809',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(235,	'LukHash',	'https://assets.ppy.sh/medals/web/all-packs-lukhash.png',	'There\'s a ghost in this here machine.',	'NULL',	'Beatmap Packs',	'<i>Play all of the LukHash pack.</i>',	5,	'0,0,1758,0',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(236,	'*namirin',	'https://assets.ppy.sh/medals/web/all-packs-namirin.png',	'Five colors to make your world sing!',	'NULL',	'Beatmap Packs',	'<i>Play all of the *namirin pack.</i>',	5,	'1704',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(237,	'onumi',	'https://assets.ppy.sh/medals/web/all-packs-onumi.png',	'There\'s a lot going on here.',	'NULL',	'Beatmap Packs',	'<i>Play all of the onumi pack.</i>',	5,	'1804',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(238,	'The Flashbulb',	'https://assets.ppy.sh/medals/web/all-packs-theflashbulb.png',	'Not merely incandescent.',	'NULL',	'Beatmap Packs',	'<i>Play all of The Flashbulb pack.</i>',	5,	'1762',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(239,	'Undead Corporation',	'https://assets.ppy.sh/medals/web/all-packs-undeadcorporation.png',	'Diversifying underground assets. Literally.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Undead Corporation pack.</i>',	5,	'1810',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(240,	'Wisp X',	'https://assets.ppy.sh/medals/web/all-packs-wispx.png',	'Sunset and the moon.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Wisp X pack.</i>',	5,	'1806',	NULL,	'0000-00-00',	NULL,	NULL,	1,	0),
(241,	'Winter 2020 Beatmap Spotlights',	'https://assets.ppy.sh/medals/web/spotlight-2020-winter.png',	'The best of Winter 2020 in beatmap form!',	'NULL',	'Beatmap Spotlights',	'<i>Play all of the maps from one mode of the Winter 2020 Beatmap Spotlights.</i>',	8,	'1896,1897,1898,1899',	'',	'0000-00-00',	NULL,	NULL,	1,	0),
(242,	'Event Horizon',	'https://assets.ppy.sh/medals/web/osu-skill-pass-9.png',	'No force dares to pull you under.',	'osu',	'Skill & Dedication',	'<i>Stare into the abyss, and pass the trial of any 9 star map.</i>',	4,	NULL,	NULL,	'2020-06-19',	NULL,	NULL,	1,	0),
(243,	'Chosen',	'https://assets.ppy.sh/medals/web/osu-skill-fc-9.png',	'Reign among the Prometheans, where you belong.',	'osu',	'Skill & Dedication',	'<i>Triumph over one of the hardest beatmaps ever made, and FC a 9 star map.</i>',	5,	NULL,	NULL,	'2020-06-19',	NULL,	NULL,	1,	0),
(244,	'Phantasm',	'https://assets.ppy.sh/medals/web/osu-skill-pass-10.png',	'Fevered is your passion, extraordinary is your skill.',	'osu',	'Skill & Dedication',	'<i>Approach the limit of human endurance, and pass a 10 star map.</i>',	4,	'',	'gr7Guy7vAEA',	'2020-06-19',	NULL,	NULL,	1,	0),
(245,	'Unfathomable',	'https://assets.ppy.sh/medals/web/osu-skill-fc-10.png',	'You have no equal.',	'osu',	'Skill & Dedication',	'<i>Cement your place among legends, and FC any 10 star map.</i>',	5,	'',	'',	'2020-06-19',	'2020-10-27',	1920049,	1,	0),
(246,	'Camellia I',	'https://assets.ppy.sh/medals/web/all-packs-camellia-1.png',	'This is the entrance to the jungle.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Camellia Sets pack.</i>',	5,	'2051',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(247,	'Camellia II',	'https://assets.ppy.sh/medals/web/all-packs-camellia-2.png',	'Exit the atmosphere.',	'NULL',	'Beatmap Challenge Packs',	'<i>Play all of the Camellia Challenges pack, which requires no difficulty reduction mods active.</i>',	6,	'2053',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(248,	'Celldweller',	'https://assets.ppy.sh/medals/web/all-packs-celldweller.png',	'The end of an empire is no obstacle to you.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Celldweller pack.</i>',	5,	'2040',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(249,	'Cranky II',	'https://assets.ppy.sh/medals/web/all-packs-cranky2.png',	'Even crankier than before!',	'NULL',	'Beatmap Packs',	'<i>Play all of the Cranky 2 pack.</i>',	5,	'2049',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(250,	'Cute Anime Girls',	'https://assets.ppy.sh/medals/web/all-packs-CuteAnimeGirls.png',	'Not to be confused with cute flambé grills.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Cute Anime Girls pack.</i>',	5,	'2031',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(251,	'ELFENSJoN',	'https://assets.ppy.sh/medals/web/all-packs-ELFENSJoN.png',	'A world all of your own.',	'NULL',	'Beatmap Packs',	'<i>Play all of the ELFENSJoN pack.</i>',	5,	'2047',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(252,	'Hyper Potions',	'https://assets.ppy.sh/medals/web/all-packs-HyperPotions.png',	'Gain 200 HP.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Hyper Potions pack.</i>',	5,	'2037',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(253,	'Kola Kid',	'https://assets.ppy.sh/medals/web/all-packs-KolaKid.png',	'Remember, the Earth is counting on you.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Kola Kid pack.</i>',	5,	'2044',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(254,	'LeaF',	'https://assets.ppy.sh/medals/web/all-packs-leaf.png',	'Calamity was not in your fortune.',	'NULL',	'Beatmap Packs',	'<i>Play all of the LeaF pack.</i>',	5,	'2039',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(255,	'Panda Eyes',	'https://assets.ppy.sh/medals/web/all-packs-PandaEyes.png',	'Embrace the immortal flame.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Panda Eyes pack.</i>',	5,	'2043',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(256,	'PUP',	'https://assets.ppy.sh/medals/web/all-packs-PUP.png',	'Finally, some closure.',	'NULL',	'Beatmap Packs',	'<i>Play all of the PUP pack.</i>',	5,	'2048',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(257,	'Ricky Montgomery',	'https://assets.ppy.sh/medals/web/all-packs-RickyMontgomery.png',	'All hook and sinker.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Ricky Montgomery pack.</i>',	5,	'2046',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(258,	'Rin',	'https://assets.ppy.sh/medals/web/all-packs-Rin.png',	'Two minds, and a house full of ghosts.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Rin/Function Phantom pack.</i>',	5,	'1759',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(259,	'S3RL',	'https://assets.ppy.sh/medals/web/all-packs-S3RL.png',	'You\'ll never get any of these out of your head.',	'NULL',	'Beatmap Packs',	'<i>Play all of the S3RL pack.</i>',	5,	'2045',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(260,	'Sound Souler',	'https://assets.ppy.sh/medals/web/all-packs-SoundSouler.png',	'Return color to your life.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Sound Souler pack.</i>',	5,	'2038',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(261,	'Teminite',	'https://assets.ppy.sh/medals/web/all-packs-Teminite.png',	'It\'s all about the state of mind.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Teminite pack.</i>',	5,	'2042',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(262,	'VINXIS',	'https://assets.ppy.sh/medals/web/all-packs-VINXIS.png',	'Staying on track.',	'NULL',	'Beatmap Packs',	'<i>Play all of the VINXIS pack.</i>',	5,	'2041',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(263,	'Mappers\' Guild Pack V',	'https://assets.ppy.sh/medals/web/all-packs-mappersguild-05.png',	'Invisible birdwatching.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Mappers\' Guild V pack.</i>',	5,	'2032',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(264,	'Mappers\' Guild Pack VI',	'https://assets.ppy.sh/medals/web/all-packs-mappersguild-06.png',	'Turn your superpower to hyperdrive!',	'NULL',	'Beatmap Packs',	'<i>Play all of the Mappers\' Guild VI pack.</i>',	5,	'2033',	NULL,	'2020-11-20',	NULL,	NULL,	1,	0),
(265,	'Mappers\' Guild Pack VII',	'https://assets.ppy.sh/medals/web/all-packs-mappersguild-07.png',	'A new set of vibrant challenges to overcome.',	'NULL',	'Beatmap Challenge Packs',	'<i>Play all of the Mappers\' Guild VII pack, which require no difficulty reduction mods when submitting a score.</i>',	6,	'2034',	'',	'2020-11-20',	NULL,	NULL,	1,	0),
(266,	'Mappers\' Guild Pack VIII',	'https://assets.ppy.sh/medals/web/all-packs-mappersguild-08.png',	'Succeed with a chorus of voices.',	'NULL',	'Beatmap Challenge Packs',	'<i>Play all of the Mappers\' Guild VIII pack, which require no difficulty reduction mods when submitting a score.</i>',	6,	'2035,,,',	'',	'2020-11-20',	'0000-00-00',	0,	1,	0),
(267,	'Mappers\' Guild Pack IX',	'https://assets.ppy.sh/medals/web/all-packs-mappersguild-09.png',	'This is no subtle change.',	'NULL',	'Beatmap Challenge Packs',	'<i>Play all of the Mappers\' Guild IX pack, which require no difficulty reduction mods when submitting a score.</i>',	6,	'2036',	'',	'2020-11-20',	NULL,	NULL,	1,	0),
(268,	'Ten To One',	'https://assets.ppy.sh/medals/web/all-secret-tentoone.png',	'From one extreme to another.',	'NULL',	'Hush-Hush',	'<i>From a marathon to a sprint.</i>',	2,	'',	'',	NULL,	'2021-12-31',	11554464,	1,	0),
(269,	'Exquisite',	'https://assets.ppy.sh/medals/web/all-secret-exquisite.png',	'Indubitably.',	'NULL',	'Hush-Hush',	'<i>Do it once with true calibre, then do it again.</i>',	2,	'',	'b_veNxs4VXA',	NULL,	'2021-12-31',	3819901,	1,	0),
(270,	'Persistence Is Key',	'https://assets.ppy.sh/medals/web/all-secret-persistenceiskey.png',	'Don\'t let your dreams be dreams.',	'NULL',	'Hush-Hush',	'<i>Don\'t give up!</i>',	2,	'',	'',	'2021-12-31',	'2021-12-31',	3031177,	1,	0),
(271,	'Mad Scientist',	'https://assets.ppy.sh/medals/web/all-secret-madscientist.png',	'The experiment... it\'s all gone!',	'NULL',	'Hush-Hush',	'<i>Become invisible.</i>',	2,	'',	'85zNEZLZlFU',	'2021-12-31',	'2021-12-31',	4687701,	1,	0),
(272,	'Tribulation',	'https://assets.ppy.sh/medals/web/all-secret-tribulation.png',	'Success is inevitable... eventually.',	'NULL',	'Hush-Hush',	'<i>Struggle and then stop.</i>',	2,	'0',	'9eeMH0_P1lM',	'2022-05-02',	NULL,	NULL,	1,	0),
(273,	'Right On Time',	'https://assets.ppy.sh/medals/web/all-secret-rightontime.png',	'The first minute is always the hardest.',	'NULL',	'Hush-Hush',	'<i>Every hour\'s got sixty, but your timer only wants one.</i>',	2,	'',	'6MpYdHdLGs8',	'2022-05-02',	'2022-05-02',	10249166,	1,	0),
(274,	'Replica',	'https://assets.ppy.sh/medals/web/all-secret-replica.png',	'One just like the other.',	'NULL',	'Hush-Hush',	'<i>Duplicate.</i>',	2,	'',	'',	'0000-00-00',	'2022-05-03',	5510197,	1,	0),
(275,	'All Good',	'https://assets.ppy.sh/medals/web/all-secret-allgood.png',	'Better now, thanks!',	'NULL',	'Hush-Hush',	'<i>You got this.</i>',	2,	'',	'',	'2022-05-02',	'2022-05-02',	10249166,	1,	0),
(276,	'Dead Center',	'https://assets.ppy.sh/medals/web/all-secret-deadcenter.png',	'As all things should be.',	'NULL',	'Hush-Hush (Expert)',	'<i>Perfect balance.</i>',	3,	'0',	'',	'2022-06-09',	NULL,	NULL,	1,	0),
(277,	'In Memoriam',	'https://assets.ppy.sh/medals/web/osu-secret-inmemoriam.png',	'In loving memory of your sanity, long forgotten.',	'osu',	'Hush-Hush',	'<i>Conquer a test of the most frustrating combination of mods imaginable.</i>',	2,	'0',	'',	'2022-06-09',	NULL,	NULL,	1,	0),
(278,	'Sanguine',	'https://assets.ppy.sh/medals/web/osu-secret-sanguine.png',	'Timeless thorns still draw blood.',	'osu',	'Hush-Hush',	'<i>Return to the past, when everything was simpler.</i>',	2,	'0',	'DrvD73w2wdA',	'2022-06-09',	NULL,	NULL,	1,	0),
(279,	'Not Again',	'https://assets.ppy.sh/medals/web/all-secret-notagain.png',	'Regret everything.',	'NULL',	'Hush-Hush',	'<i>You had it all, and then it was gone.</i>',	2,	'',	'PFgkS7aIYQ4',	'2022-06-09',	'2022-06-09',	4687701,	1,	0),
(280,	'Final Boss',	'https://assets.ppy.sh/medals/web/osu-secret-finalboss.png',	'Game over.',	'osu',	'Hush-Hush (Expert)',	'<i>Let the credits roll.</i>',	3,	'',	'5VHyPf6cdZo',	'2022-06-09',	'2022-06-09',	9975427,	1,	0),
(281,	'Beast Mode',	'https://assets.ppy.sh/medals/web/osu-secret-beastmode.png',	'Unleash the animal within!',	'osu',	'Hush-Hush (Expert)',	'<i>Go absolutely feral.</i>',	3,	'',	'y6M51Y3VE10',	'2022-06-09',	'2022-06-09',	11715109,	1,	0),
(282,	'Touhou Pack',	'https://assets.ppy.sh/medals/web/all-packs-touhou.png',	'The bamboo isn\'t the only thing dancing!',	'NULL',	'Beatmap Packs',	'<i>Play all of the Touhou beatmap pack.</i>',	5,	'2457',	'',	'2022-07-25',	NULL,	NULL,	1,	0),
(283,	'ginkiha Pack',	'https://assets.ppy.sh/medals/web/all-packs-ginkiha.png',	'The night stars shine the brightest of all.',	'NULL',	'Beatmap Packs',	'<i>Play all of the ginkiha beatmap pack.</i>',	5,	'2458',	'',	'2022-07-25',	NULL,	NULL,	1,	0),
(284,	'MUZZ Pack',	'https://assets.ppy.sh/medals/web/all-packs-muzz.png',	'Break away from the endgame.',	'NULL',	'Beatmap Challenge Packs',	'<i>Play all of the MUZZ beatmap pack, which requires no difficulty reduction mods when submitting a score.</i>',	6,	'2459',	'',	'2022-07-25',	NULL,	NULL,	1,	0),
(285,	'Deliberation',	'https://assets.ppy.sh/medals/web/all-secret-deliberation.png',	'The challenge remains.',	'NULL',	'Hush-Hush',	'<i>Turn a short challenge into a long one.</i>',	2,	'',	'YktCZN6Ur_4',	'2022-09-09',	'2022-09-10',	1719471,	1,	0),
(286,	'Lightless',	'https://assets.ppy.sh/medals/web/all-secret-lightless.png',	'Better the devil you know.',	'NULL',	'Hush-Hush (Expert)',	'<i>I CAN\'T SEE A THING.</i>',	3,	'',	'uE36Go4kQWA',	NULL,	'2022-09-14',	2229274,	1,	0),
(287,	'When You See It',	'https://assets.ppy.sh/medals/web/all-secret-when-you-see-it.png',	'Three numbers which will haunt you forevermore.',	'NULL',	'Hush-Hush',	'<i>You don\'t need a hint for this one.</i>',	2,	'',	'XI6nV8Qj2gs',	'2022-09-09',	'2022-09-10',	29473368,	1,	0),
(288,	'Vocaloid Pack',	'https://assets.ppy.sh/medals/web/all-packs-vocaloid.png',	'What\'s life without a song?',	'NULL',	'Beatmap Packs',	'<i>Play all of the Vocaloid beatmap pack.</i>',	5,	'2481',	'',	'2022-09-10',	NULL,	NULL,	1,	0),
(289,	'Maduk Pack',	'https://assets.ppy.sh/medals/web/all-packs-maduk.png',	'You took control.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Maduk beatmap pack.</i>',	5,	'2482',	'',	'2022-09-10',	NULL,	NULL,	1,	0),
(290,	'Aitsuki Nakuru Pack',	'https://assets.ppy.sh/medals/web/all-packs-aitsuki.png',	'Took part in the Joker\'s Parade.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Aitsuki Nakuru beatmap pack.</i>',	5,	'2483',	'',	'2022-09-10',	NULL,	NULL,	1,	0),
(291,	'30,000,000 Drum Hits',	'https://assets.ppy.sh/medals/web/taiko-hits-30000000.png',	'Your rhythm, eternal.',	'taiko',	'Skill & Dedication',	NULL,	3,	'',	'',	'2022-11-04',	'0000-00-00',	0,	1,	0),
(292,	'Catch 20,000,000 fruits',	'https://assets.ppy.sh/medals/web/fruits-hits-20000000.png',	'Nothing left behind.',	'fruits',	'Skill & Dedication',	NULL,	3,	'',	'',	NULL,	'0000-00-00',	0,	1,	0),
(293,	'40,000,000 Keys',	'https://assets.ppy.sh/medals/web/mania-hits-40000000.png',	'When someone asks which keys you play, the answer is now \'yes\'.',	'mania',	'Skill & Dedication',	NULL,	3,	'',	'',	'2022-11-04',	'0000-00-00',	0,	1,	0),
(294,	'Ariabl\'eyeS Pack',	'https://assets.ppy.sh/medals/web/all-packs-ariableyes.png',	'Command the mercurial skies.',	'NULL',	'Beatmap Challenge Packs',	'<i>Play all of the Ariabl\'eyes beatmap pack, which requires no difficulty reduction mods.</i>',	6,	'2521,,,',	'',	'0000-00-00',	'0000-00-00',	0,	1,	0),
(295,	'Omoi Pack',	'https://assets.ppy.sh/medals/web/all-packs-omoi.png',	'A whole new meaning to chill.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Omoi beatmap pack.</i>',	5,	'2522,,,',	'',	'2022-11-04',	'2022-11-04',	18152711,	1,	0),
(296,	'Chill Pack',	'https://assets.ppy.sh/medals/web/all-packs-chill.png',	'Just vibin\'.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Chill beatmap pack.</i>',	5,	'2523,,,',	'',	'2022-11-04',	'2022-11-04',	7279762,	1,	0),
(297,	'Mortal Coils',	'https://assets.ppy.sh/medals/web/all-secret-together-apart.png',	'Never one without the other.',	'osu',	'Hush-Hush (Expert)',	'<i>Prisoners of flesh in an unending apocalypse.</i>',	3,	'',	'',	'2022-11-04',	'0000-00-00',	0,	1,	0),
(298,	'Dark Familiarity',	'https://assets.ppy.sh/medals/web/all-secret-dark-familiarity.png',	'No mistakes, no witnesses.',	'osu',	'Hush-Hush (Expert)',	'<i>Don\'t second guess yourself.</i>',	3,	'',	'',	'2022-11-04',	'2022-11-04',	11220416,	1,	0),
(299,	'Creator\'s Gambit',	'https://assets.ppy.sh/medals/web/all-secret-trophy.png',	'I made this.',	'NULL',	'Hush-Hush (Expert)',	'<i>Make your own prize.</i>',	3,	'',	'',	NULL,	'2022-11-04',	11220416,	1,	0),
(300,	'Time Sink',	'https://assets.ppy.sh/medals/web/all-secret-time-sink.png',	'Rise from the depths into a new age.',	'NULL',	'Hush-Hush',	'<i>Descend into the fathoms, yesteryear and today.</i>',	2,	'',	'',	'2023-05-30',	'2023-06-05',	32737263,	1,	0),
(301,	'Unseen Heights',	'https://assets.ppy.sh/medals/web/all-secret-unseen-heights.png',	'Reach for the stars.',	'NULL',	'Hush-Hush (Expert)',	'<i>Go where even the editor fears to tread.</i>',	3,	'',	'ybqTDET3Hiw',	'2023-05-30',	'2023-05-30',	8183049,	1,	0),
(302,	'You\'re Here Forever',	'https://assets.ppy.sh/medals/web/all-secret-youre-here-forever.png',	'We knew you\'d be back.',	'NULL',	'Hush-Hush',	'<i>Touch grass.</i>',	2,	'',	'',	'2023-05-30',	'2023-05-30',	23303064,	1,	0),
(303,	'Hospitality',	'https://assets.ppy.sh/medals/web/all-secret-hospitality.png',	'Welcome.',	'NULL',	'Hush-Hush',	'<i>From guest, to host.</i>',	2,	'',	'',	'2023-05-30',	'2023-05-30',	14462628,	1,	0),
(304,	'True North',	'https://assets.ppy.sh/medals/web/all-secret-true-north.png',	'Where they tread, you go.',	'NULL',	'Hush-Hush',	'<i>Seek your favourite creator to lead the way.</i>',	2,	'',	'',	'2023-05-30',	'2023-05-30',	8492584,	1,	0),
(305,	'Astronomic',	'https://assets.ppy.sh/medals/web/all-secret-astronomic.png',	'Precision machinery.',	'NULL',	'Hush-Hush (Expert)',	'<i>Celestial coordinates: 284-905.</i>',	3,	'',	'',	'2023-05-30',	'2023-05-30',	21041783,	1,	0),
(306,	'Superfan',	'https://assets.ppy.sh/medals/web/all-secret-superfan.png',	'THIS IS MY JAM.',	'NULL',	'Hush-Hush',	'<i>AHHHHHH THEY\'RE MY OSHI.</i>',	2,	'',	'',	'2023-05-30',	'2023-05-30',	8202576,	1,	0),
(307,	'Iron Will',	'https://assets.ppy.sh/medals/web/all-secret-iron-will.png',	'A legacy of broken bonds, remade.',	'osu',	'Hush-Hush (Expert)',	'<i>Step forth, and master three years of titan-ending tests.</i>',	3,	'',	'',	'2023-05-30',	'2023-05-30',	5242158,	1,	0),
(308,	'USAO Pack',	'https://assets.ppy.sh/medals/web/all-packs-usao.png',	'Now THAT is a showdown.',	'NULL',	'Beatmap Challenge Packs',	'<i>Play all of the USAO beatmap pack, which requires no difficulty reduction mods.</i>',	6,	'F1,,,',	NULL,	'2023-05-30',	NULL,	NULL,	1,	0),
(309,	'Rohi Pack',	'https://assets.ppy.sh/medals/web/all-packs-rohi.png',	'An artifact of true skill.',	'NULL',	'Beatmap Packs',	'<i>Play all of the Rohi beatmap pack.</i>',	5,	'F2,,,',	NULL,	'2023-05-30',	NULL,	NULL,	1,	0),
(310,	'Drum & Bass Pack',	'https://assets.ppy.sh/medals/web/all-packs-drum_and_bass.png',	'727? More like 174, baby!',	'NULL',	'Beatmap Packs',	'<i>Play all of the Drum & Bass beatmap pack.</i>',	5,	'T113,,,',	NULL,	'2023-05-30',	NULL,	NULL,	1,	0),
(311,	'Project Loved: Winter 2021',	'https://assets.ppy.sh/medals/web/loved-seasonal-2021-winter.png',	'You\'re very welcome for the music.',	'NULL',	'Beatmap Packs',	'<i>Play any of the Project Loved: Winter 2021 beatmap packs.</i>',	6,	'L1,L2,L4,L3',	'',	'2023-06-19',	'2023-01-01',	0,	1,	0),
(312,	'Project Loved: Spring 2022',	'https://assets.ppy.sh/medals/web/loved-seasonal-2022-spring.png',	'You promised that foolish heroes would be good for me...',	'NULL',	'Beatmap Packs',	'<i>Play any of the Project Loved: Spring 2022 beatmap packs.</i>',	6,	'L5,L6,L8,L7',	'',	'2023-06-19',	NULL,	0,	1,	0),
(313,	'Project Loved: Summer 2022',	'https://assets.ppy.sh/medals/web/loved-seasonal-2022-summer.png',	'Alright, fine. You don\'t sound like dragonforce.',	'NULL',	'Beatmap Packs',	'<i>Play any of the Project Loved: Summer 2022 beatmap packs.</i>',	6,	'L9,L10,L12,L11',	'',	'2023-06-19',	NULL,	0,	1,	0),
(314,	'Project Loved: Autumn 2022',	'https://assets.ppy.sh/medals/web/loved-seasonal-2022-autumn.png',	'There\'s a god-ish bee in my damned salad.',	'NULL',	'Beatmap Packs',	'<i>Play any of the Project Loved: Autumn 2022 beatmap packs.</i>',	6,	'L13,L14,L16,L15',	'',	'2023-06-19',	NULL,	0,	1,	0),
(315,	'Project Loved: Winter 2022',	'https://assets.ppy.sh/medals/web/loved-seasonal-2022-winter.png',	'Chasing nightmares in square, alien and propane forms.',	'NULL',	'Beatmap Packs',	'<i>Play any of the Project Loved: Winter 2022 beatmap packs.</i>',	6,	'L17,L18,L20,L19',	'',	'2023-06-19',	NULL,	0,	1,	0),
(316,	'Project Loved: Spring 2023',	'https://assets.ppy.sh/medals/web/loved-seasonal-2023-spring.png',	'Phase one: turn all humans and their fickle souls into orange cordial.',	'NULL',	'Beatmap Packs',	'<i>Play any of the Project Loved: Spring 2023 beatmap pack.</i>',	6,	'L21,L22,L24,L23',	'',	'2023-06-19',	NULL,	0,	1,	0),
(317,	'Resurgence',	'https://assets.ppy.sh/medals/web/all-secret-resurgence.png',	'A flame rekindled.',	'NULL',	'Hush-Hush',	'<i>From the ashes, blaze bright.</i>',	2,	'',	'',	'2023-07-27',	'2023-07-27',	8171561,	1,	0),
(318,	'Clarity',	'https://assets.ppy.sh/medals/web/all-secret-clarity.png',	'And yet in our memories, you remain crystal clear.',	'NULL',	'Hush-Hush',	'<i>A distorted reality and our own intersect.</i>',	2,	'',	'',	'2023-07-27',	'2023-07-27',	13175102,	1,	0),
(319,	'Autocreation',	'https://assets.ppy.sh/medals/web/all-secret-autocreation.png',	'Absolute rule.',	'NULL',	'Hush-Hush',	'<i>One is all.</i>',	2,	'',	'',	'2023-07-27',	'2023-07-27',	27833018,	1,	0),
(320,	'Star Power',	'https://assets.ppy.sh/medals/web/all-secret-star-power.png',	'AND I\'LL DO IT AGAIN.',	'NULL',	'Hush-Hush (Expert)',	'<i>When an encore just isn\'t enough.</i>',	3,	NULL,	NULL,	'2023-07-27',	NULL,	NULL,	0,	1),
(321,	'Causality',	'https://assets.ppy.sh/medals/web/osu-secret-causality.png',	'Definitely not for casuals.',	'osu',	'Hush-Hush (Expert)',	'<i>Flee from the future.</i>',	3,	'',	'',	'2023-07-27',	'2023-07-27',	15193535,	1,	0),
(322,	'Abrogation',	'https://assets.ppy.sh/medals/web/osu-secret-abrogation.png',	'Endure not the imposition of celestial law.',	'osu',	'Hush-Hush (Expert)',	'<i>Return to whence the rules were first broken.</i>',	3,	'',	'',	'2023-07-27',	'2023-07-27',	4455632,	1,	0),
(323,	'Internment',	'https://assets.ppy.sh/medals/web/osu-secret-internment.png',	'Stained in the hues of madness, they rage within a four-walled jail.',	'osu',	'Hush-Hush (Expert)',	'<i>Bask in the shade of an ailing mind.</i>',	3,	NULL,	NULL,	'2023-07-27',	NULL,	NULL,	0,	1),
(324,	'Anabasis',	'https://assets.ppy.sh/medals/web/taiko-secret-anabasis.png',	'And what an adventure you had.',	'taiko',	'Hush-Hush (Expert)',	'<i>Life is but a journey of the senses.</i>',	3,	'',	'',	'2023-07-27',	'2023-07-27',	7528639,	1,	0);
...
DROP TABLE IF EXISTS `SolutionTracker`;
CREATE TABLE `SolutionTracker` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
